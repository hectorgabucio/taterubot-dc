...
// DiscordClient is an autogenerated mock type for the Client type
type DiscordClient struct {
	mock.Mock
}

// CreateChannel provides a mock function with given fields: guildID, name, channelType, maxUsers
func (_m *DiscordClient) CreateChannel(guildID string, name string, channelType discord.ChannelType, maxUsers int) (discord.Channel, error) {
...
func (_m *DiscordClient) EditInteraction(token string, message string) error {
...
func (_m *DiscordClient) EditInteractionComplex(token string, edit discord.ComplexInteractionEdit) error {
...
func (_m *DiscordClient) EndVoiceConnection(voice *discord.VoiceConnection) error {
	ret := _m.Called(voice)
...
func (_m *DiscordClient) GetBotUsername() string {
	ret := _m.Called()
...
func (_m *DiscordClient) GetChannel(channelID string) (discord.Channel, error) {
...
func (_m *DiscordClient) GetGuildChannels(guildID string) ([]discord.Channel, error) {
...
func (_m *DiscordClient) GetGuildUsers(guildID string) ([]discord.User, error) {
	ret := _m.Called(guildID)
...
func (_m *DiscordClient) GetGuilds() ([]discord.Guild, error) {
	ret := _m.Called()
...
func (_m *DiscordClient) GetUser(userID string) (discord.User, error) {
...
func (_m *DiscordClient) JoinVoiceChannel(guildID string, channelID string, mute bool, deaf bool) (*discord.VoiceConnection, error) {
...
func (_m *DiscordClient) SendFileMessage(channelID string, name string, contentType string, readable io.Reader) (discord.Message, error) {
...
func (_m *DiscordClient) SendTextMessage(channelID string, message string) error {
...
func (_m *DiscordClient) SetEmbed(channelID string, messageID string, embed discord.MessageEmbed) error {
